package com.yun.software.yunlearn.TreeMap;
...
public class Test {
    ...
    public void test(){
        ...
        Student s2 = new Student("aaaaa", 29);
    ...
    @org.junit.Test
    public void test02(){
        System.out.println("yanliang".compareTo("yan"));
    }
    ...
    public void lookPoker(String name, ArrayList<String> array) {
